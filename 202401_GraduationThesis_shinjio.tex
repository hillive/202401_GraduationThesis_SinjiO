...
\longtitle{VRゲームにおける}{魔法体験を向上させる振動刺激の調査}
...
% 概要
\jabst{
\input{./body/0_abstract.tex}    % abstract.texを読み込む
}
\makejabstract
...
\input{./body/1_preface}     % 第1章
\input{./body/2_related}     % 第2章
\input{./body/3_approach}    % 第3章
\input{./body/4_implement}   % 第4章
\input{./body/5_assessment}  % 第5章
\input{./body/6_conclusion}  % 第6章
\input{./body/98_ack}         % 謝辞
\input{./body/99_bibliography}% 参考文献
